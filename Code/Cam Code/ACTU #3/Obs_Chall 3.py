...
def giro_con_imu(steering, angulo_obj, vel):
    ...
    MIN_SPEED = 250       # Minimum speed when close to target
...
def look_for_block(speed,angle,dist=1100):
...
def salida_counter():
    global pfin 
    wait(500)
    giro_con_imu(-65, -70, 200)
    color = lectura()
    if color < 15:
        print('Salida_counterR')
        giro_con_imu(35,0,200)
        curva_v()
    elif color > 15:
        print('salida_counterV')
        giro_con_imu(-40,-110,200)
        drive_with_heading_lock(-100,200,1,300)
...
def salida_clock():
    ...
    if color > 15:
        print('Salida_clockV')
        car.steer(0)
        drive_with_heading_lock(55,200,5,950)
        giro_con_imu(-30,0,300)
        pfin = 2
        curvas()
    elif color < 15:
...
def verde():
    ...
    print(dist_izq())
    sigue_pared(325,500,1,1,angle=40, p=daniel)
    print(dist_izq())
        ...
        if probot == 0: 
            ...
            if 0 < color < 15:
                ...
                if color == 0:
                    ...
                    print('vi algo')
                    if color < 15:
                        drive_with_heading_lock(daniel+30,300,3,100)
            ...
            if color == 0:
                ...
                print('vi algo')
                if color < 15:
                        giro_con_imu(45,70+daniel,500)
                        sigue_pared(375,300,3,2,angle=57,p=daniel)
                        print(dist_der())
                        giro_con_imu(-40,0 + daniel,500)
                        print('rojo')
                        pfin = 1
            ...
            while True:
                ...
                if 0 < color < 15:
                    ...
                    giro_con_imu(40,55+daniel,850)
                    print('ROJO')
                    sigue_pared(350,300,2,2,angle=60,p=daniel)
                    print('Termine sigue pared')
                    print(dist_der())
                    giro_con_imu(-40,0 + daniel,500)
                    pfin = 1
        ...
        if probot == 0:
            if 0 < color < 15:
                ...
                if color < 15:
                    ...
                    drive_with_heading_lock(daniel-30,400,1,750)
                    drive_with_heading_lock(danile,400,1,1100)
        elif probot == 1:
                print('jaja=',probot)
                look_for_block(500,daniel)
                wait(250)
