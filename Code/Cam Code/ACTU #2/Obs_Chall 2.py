...
def sigue_pared(dist, speed, sensor, direction, value=40, angle=50, p=0):
...
def verde():
    global constV,daniel
    constV += daniel
    giro_con_imu(-40,-40+daniel,500)
    sigue_pared(300,500,2,1, p=daniel)
    giro_con_imu(40,daniel,500)


def rojo():
    global constR,daniel
    constR += daniel
    giro_con_imu(40,55+daniel,600)
    sigue_pared(300,300,2,2,angle=50,p=daniel)
    print(dist_der())
    giro_con_imu(-40,0,500)

def rojo2():
    drive_with_heading_lock(0,500,1,850)
    giro_con_imu(50,90,400)

def verde2():
    drive_with_heading_lock(0,500,1,300)
    giro_con_imu(50,90,400)
...
def navegacion():
    ...
    if juju() < 15:
        ...
        if juju() == 0:
            ...
            print('vi algo')
            if juju() < 15:
                drive_with_heading_lock(0,500,1,1000)
                print(juju())
                jiji = 1
        ...
        if juju() == 0:
            ...
            if juju() < 15:
                ...
                drive_with_heading_lock(-3,500,1,1000)
                print('verde')
                jiji = 2
...
def curva_v():
    print(dist_front())
    drive_with_heading_lock(-3,700,1,700)
